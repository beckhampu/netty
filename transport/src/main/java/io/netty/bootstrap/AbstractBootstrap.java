...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
    ...
    /**
     * EventLoopGroup对象.
     * 对于ServerBootstrap为boss，对于Bootstrap为worker.
     */
    volatile EventLoopGroup group;
    @SuppressWarnings("deprecation")
    /**
     * channel创建工厂,用于创建Channel对象
     */
    ...
    /**
     * 构造方法，声明了两个泛型
     * B继承 AbstractBootstrap 类，用于表示自身的类型
     * C继承 Channel 类，表示创建的 Channel的类型
     * @param bootstrap
     */
    ...
    public B channel(Class<? extends C> channelClass) {
        ...
        //设置channelFactory，ReflectiveChannelFactory是通过channel的class类型来创建channel
     ...
     * 父类方法主要校验EventLoopGroup和ChannelFactory是否赋值.
     */
    @SuppressWarnings("unchecked")
    public B validate() {
        if (group == null) {
     ...
     *
     * 已禁用，可通过config()方法获取到AbstractBootstrapConfig对应子类进行配置属性的获取.
     */
    @Deprecated
